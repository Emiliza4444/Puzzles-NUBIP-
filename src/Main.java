...
public class Main extends Application {
    ...
    private static Node createMenu(){
        ...
        MenuItem aboutMenuItem = new MenuItem("Rules");
        aboutMenuItem.setOnAction(event -> {
            showMessageDialog(null,
                    "Rules of the game\n" +
                    "\n" +
                    "The pieces cannot be lifted out of the frame or rearranged in any way, except by sliding them into an empty space by clicking mouse left button.\n" +
                    "\n" +
                    "The goal of a sliding puzzle is to arrange the pieces in a particular image. You can choose one of the in-game images or upload your one with 480x480 resolution.\n"+
                    "\n" +
